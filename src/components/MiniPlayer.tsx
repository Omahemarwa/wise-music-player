...
export const MiniPlayer: React.FC<MiniPlayerProps> = ({
  ...
  return (
    <div className="fixed bottom-[74px] left-0 right-0 z-30 max-w-md mx-auto px-3 pointer-events-none">
      <div className="pointer-events-auto relative overflow-hidden rounded-2xl bg-[#1c1a26]/95 backdrop-blur-xl border border-white/10 shadow-2xl p-2.5 flex items-center justify-between transition-all">
        ...
        >
          <div className="relative w-11 h-11 rounded-lg overflow-hidden flex-shrink-0 ring-1 ring-[#7c3aed]/40 bg-[#12111a]">
            <img
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[11px] text-[#958da1] truncate mt-0.5">
              {currentTrack.artist}
              {currentTrack.format && (
                <span className="text-[10px] text-[#c7bfff]/70 ml-1.5 uppercase font-mono">
                  • {currentTrack.format}
                </span>
              )}
            </p>
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full flex items-center justify-center text-[#958da1] hover:text-white active:scale-90 transition-transform"
            aria-label="Favorite"
          >
            <Heart 
              className={`w-4 h-4 ${
          ...
          <button
            ...
            className="w-8 h-8 rounded-full flex items-center justify-center text-white/80 hover:text-white active:scale-90 transition-transform"
