  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full max-w-md h-full min-h-[750px] max-h-[920px] bg-[#181724] text-white flex flex-col justify-between overflow-hidden relative shadow-2xl rounded-[36px] border border-white/10"
      >
        ...
        <div className="px-6 pb-6 pt-1 flex flex-col z-20">
          ...
          <div className="flex items-center justify-center gap-2.5 mt-1">
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 text-white/50 group-hover:text-white transition-transform ${
          ...
          <div className="w-32 h-1 bg-white/30 rounded-full mx-auto mt-5" />
        </div>
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        {t.coverUrl ? (
                          ...
                          <div className="w-10 h-10 rounded-lg bg-[#1f1d2c] flex items-center justify-center text-[#7c3aed] shrink-0">
                            ♪
                          </div>
                        )}
